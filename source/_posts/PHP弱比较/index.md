...
- 以 `0e` 开头且后续**全为纯数字**的字符串，在进行弱比较（`==`）时，会被 PHP 强制解析为科学计数法 `0 × 10^n = 0`。因此，任意两个满足此格式的字符串 `==` 判定恒为 `true`。
- 示例：
...
- 字符串和数字进行弱对比时，PHP 会从字符串开头提取数字，后面的字母直接丢弃。如果开头没有数字，则直接转为 0。
- 示例：
...
![](/img/posts/PHP弱比较/01.png)

![](/img/posts/PHP弱比较/02.png)
...
2. 构造Payload如 `?a=0a&b=1235a` 即可同时获取 `flag1` 和 `flag2`。

![](/img/posts/PHP弱比较/03.png)
...
2. 由于题目的标题是PHP，所以我们试一下 `index.php` 或者 `index.phps`。

![](/img/posts/PHP弱比较/05.png)
...
![](/img/posts/PHP弱比较/09.png)

![](/img/posts/PHP弱比较/10.png)

5. 或者用bp

![](/img/posts/PHP弱比较/11.png)
...
![](/img/posts/PHP弱比较/14.png)

![](/img/posts/PHP弱比较/15.png)

![](/img/posts/PHP弱比较/16.png)
...
![](/img/posts/PHP弱比较/17.png)

## 2. 解题思路

1. 查看源码

![](/img/posts/PHP弱比较/18.png)
...
![](/img/posts/PHP弱比较/19.png)

4. 得到flag

![](/img/posts/PHP弱比较/20.png)
...
![](/img/posts/PHP弱比较/21.png)

## 2. 解题思路

1. 分析代码

![](/img/posts/PHP弱比较/22.png)
...
![](/img/posts/PHP弱比较/23.png)

![](/img/posts/PHP弱比较/24.png)

3. 得到flag

![](/img/posts/PHP弱比较/25.png)
