...
cover: https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/cover.webp
categories:
  - 靶机练习
  - vulhub
tags:
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548344128_73s6ut.png)
...
## 3. modules六大子模块详解
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548347675_ybt08f.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548349581_4gc23b.png)

2. ？

![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548352558_gd7vde.png)

3. earch

![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548355453_1uu9rc.png)

4. use

![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548357946_t7juiw.png)

5. exit

![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548360405_fddhxa.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548363035_be4ibw.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548364453_gy9jjr.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548366672_h7ddnv.png)

```bash
use 0
```

![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548369230_cg71uw.png)

```bash
show options
```

![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548371810_8z11nl.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548374170_c9wqv4.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548375566_nt4lmv.png)

```bash
shell
```

![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548377776_ldcets.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548380613_vi3u5k.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548382260_09jdhw.png)

```bash
use 0
```

![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548384451_9n3cj6.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548386205_9kar2r.png)

查看攻击机的 IP 192.168.23.131

![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548388756_j6063s.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548390678_2m3ft0.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548393185_495tkc.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548394662_f2m8uf.png)

出现的 url 要通过社⼯等⽅法让⽬标机进⾏访问。

这里我们直接让目标机访问这个 url

![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548396431_bf1sga.png)

![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548398078_ja2n2k.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548400153_72g4bq.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548402183_o6imgd.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548403848_ds49rb.png)
...
## 3. CVE-2017-7494 SambaCry（Linux永恒之蓝）
### 3.1 简介
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548406534_bpngri.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548408291_bmfp4b.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548410520_i13r48.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548412769_m891nv.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548414367_a6ye5j.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548416666_3h4es4.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548418590_dvp0y9.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548420908_irxh9t.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548422850_7xfr0m.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548425457_y2kr65.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548427411_uto7cy.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548429038_hw1kpe.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548431048_tlplxz.png)

5. 设置远程受害主机IP 和 端口

![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548433159_qgjffz.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548434839_dum0qp.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548436355_fty1d3.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548438118_9s8j8d.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548440105_zyjjbt.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548442689_1vomvb.png)

![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548445659_7yrfia.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548447450_7a3uj9.png)

4. 把木马放到靶机并运行hello.exe，成功得到meterpreter > 后执行

![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548449451_iv3ls5.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548451308_iolibj.png)

```bash
sessions -i 1
```

![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548453612_vy1a2f.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548455154_92h8w9.png)
...
![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548456741_hv2h2b.png)

```bash
run vnc         # 开启VNC远程桌面控制
```

![](https://img.jasmine-iris.top/posts/MSF的使用以及漏洞复现/1786548459551_wb1vxn.png)